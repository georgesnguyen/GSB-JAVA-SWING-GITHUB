DROP DATABASE IF EXISTS GsbCRSlamV2015;

CREATE DATABASE IF NOT EXISTS GsbCRSlamV2015 ;
USE GsbCRSlamV2015;
...
ALTER TABLE `OFFRIR` ADD CONSTRAINT  `FK_OFFRIR_VISITEUR` FOREIGN KEY(`VIS_MATRICULE`) REFERENCES `VISITEUR`(`VIS_MATRICULE`) ;
...
ALTER TABLE `RAPPORT_VISITE` ADD CONSTRAINT  `FK_RAPPORT_VISITE_VISITEUR` FOREIGN KEY(`VIS_MATRICULE`) REFERENCES `VISITEUR`(`VIS_MATRICULE`) ;
